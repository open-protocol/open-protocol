...
test("keypair sign and verify test", async () => {
  ...
  expect(signature.toString("hex")).toBe(
    "46596a4234f507eea805e87cb10b1f26ecfb1f561547e0deb866c6cb1dc907c18f64121c2ef36807cdfecca6c20951f8d4c3f4c421b0afae58d05afc5ba7ad09"
  );

  const publicKey = Codec.encodeString(
    "75867f7c47fccf0b1efb6e17a954fd9198c41b0b5354cb59e2035a1d2d1a38a3"
  );
